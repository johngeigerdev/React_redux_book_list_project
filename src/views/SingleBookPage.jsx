...
function SingleBookPage() {
    const {id} = useParams();  //useParams is a part of react router that gets what we have in the URL and will assign it to id here
    const books = [
        {
      id: 1,
    ...
    const book = books.filter(book => book.id == id)[0] // used only 2 == signs to compare solely the type and not the value b/c will return the id as a string
